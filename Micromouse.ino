...
// ==========================================================================================
void three_way(){
  // This subroutine will triggered when there are 3 possible way opened. 
  int pot_north = pot_field[x_cor][y_cor+1];
  int pot_east  = pot_field[x_cor+1][y_cor];
  int pot_south = pot_field[x_cor][y_cor-1];
  int pot_west  = pot_field[x_cor-1][y_cor];
  ...
  if(face == north){
    ...
    else if(pot_west < pot_north && pot_west < pot_east){
      rotate_left();
      forward();
    }
  ...
  if(face == south){
    ...
    else if(pot_south < pot_west && pot_south < pot_east){
      forward();
    }
    else if(pot_east < pot_north && pot_east < pot_west){
      rotate_left();
  ...
  if(face == west){
    ...
    else if(pot_south < pot_north && pot_south < pot_west){
      rotate_left();
      forward();
    }
  }
  if(face == east){
    ...
    else if(pot_south < pot_north && pot_south < pot_east){
      rotate_right();
      forward();
    }
  }
